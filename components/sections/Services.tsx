      ...
      <FadeUp>
        ...
        <div className="text-center mb-20 px-4 sm:px-6 md:px-10 lg:px-16">
          ...
          <p className="text-gray-400 mt-6 max-w-2xl mx-auto text-sm sm:text-base md:text-lg leading-6 sm:leading-7 px-2 sm:px-0">
            I build modern, responsive and scalable web experiences using
            latest technologies.
          </p>
        </div>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-5 sm:gap-6 px-4 sm:px-6 md:px-10 lg:px-16">
          ...
          {services.map((service) => (
            ...
            >
              {/* DOT */}
              <div className="w-3 h-3 rounded-full bg-[#22D3EE] shadow-[0_0_12px_rgba(34,211,238,0.7)] mb-4" />
              ...
              {/* Hover Line */}
              <div className="mt-4 sm:mt-5 h-[1px] w-0 group-hover:w-full bg-[#22D3EE]/30 transition-all duration-500" />
            </div>
          ))}
